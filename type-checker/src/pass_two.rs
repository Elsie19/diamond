...
use parse::grammar::{MietteSpan, UntypedAst, spest_to_smiette};
...
use crate::core::ScopeStack;
use crate::pass_one::{self, FuncTable};
use crate::strata::{IR, IRMatchArm, VarGenerator};
...
where
    G: VarGenerator,
{
    pub fn new<T>(funcs: &'a FuncTable, file_name: &'a str, prog_text: &T) -> Self
    where
        T: ToString,
    {
        Self {
